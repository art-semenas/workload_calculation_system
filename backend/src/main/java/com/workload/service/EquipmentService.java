                        ...
                        .orElseThrow(
                                () ->
                                        new EntityNotFoundException(
                                                "DeviceType", request.deviceTypeId().toString()));
    ...
    public AssignmentDto addAssignment(UUID objectId, AssignmentCreateRequest request) {
        ...
        ObjectDevice inventoryDevice =
                objectDeviceRepository
                        ...
                        .orElseThrow(
                                () ->
                                        new DeviceNotInInventoryException(
                                                request.deviceTypeId().toString()));

        DeviceSystemContext context =
                contextRepository
                        .findByDeviceTypeIdAndSystemType(
                                request.deviceTypeId(), request.systemType())
                        .orElseThrow(
                                () ->
                                        new NoContextForSystemException(
                                                request.systemType().name()));
