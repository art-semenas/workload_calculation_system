...
- **`kvo` (К-во ремонтов)** = SUM of repair quantities over **work types only**; the 9 paperwork types (акты) contribute minutes but are excluded from `kvo`. Never a count of distinct types. See TOR §4.5.
