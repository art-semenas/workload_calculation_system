...
Not yet seeded — steps 6–9 (`travel`, `object_devices`, `object_repairs`, `records_tasks`), roughly
24 700 further rows. Those depend on the §8.1–§8.3 decisions, since they are the inputs the
